...
import { getDescriptionFromLexical } from "./getDescriptionFromLexical"
...
export default function LandingPageDetailView() {
    ...
    const { data: landingPage, loading } = useLandingPage(String(slug), lang)
    ...
    const jsonLd = useMemo(() => {
        ...
        const pageUrl = `${SITE_URL}/arcana/lp/${landingPage.lp_slug || slug}/`
